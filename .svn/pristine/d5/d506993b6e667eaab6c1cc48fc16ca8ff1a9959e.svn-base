...
{    
	...
	//[recordSetting setValue :[NSNumber numberWithInt:kAudioFormatAppleIMA4] forKey:AVFormatIDKey];  //caf格式
    [recordSetting setValue :[NSNumber numberWithInt:kAudioFormatLinearPCM] forKey:AVFormatIDKey]; //wav格式
	[recordSetting setValue:[NSNumber numberWithFloat:88200.0] forKey:AVSampleRateKey];
