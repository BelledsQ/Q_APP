...
@synthesize  sn,model,iswitch,iswitch_value,events,actiontime,control,weeks,onoff;
...
-(NSMutableDictionary *)NSString2Json:(NSString *)iswitch_onoff
{
    ...
    //封装mutableDictionary
    device = [[NSMutableDictionary alloc] initWithObjectsAndKeys:events,@"events",iswitch_onoff,@"iswitch",actiontime,@"actiontime",control,@"control",weeks,@"weeks",@"alarm_ctrl",@"cmd",nil];
...
-(NSMutableDictionary *)httpOnoffSwitch:(NSMutableDictionary *)control
{
    ...
    NSString *cmd = [NSString stringWithFormat:@"alarm_onoff"];
