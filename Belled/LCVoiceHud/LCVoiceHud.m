...
-(void) createMainUI{
    ...
    //CGRect frame2 = CGRectMake(_DEVICE_WIDTH/2-164/2, 200, 90, 90);
    //CGRect frame3 = CGRectMake(164/2-50/2, 164/2-93.5/2, 90, 90);
    CGRect frame2 = CGRectMake(0, 0, 90, 90);
    CGRect frame3 = CGRectMake(0, 0, 90, 90);
    CGRect frame4 = CGRectMake(0, 0, 18, 24);
    ...
    [self insertSubview:micNormalImageView atIndex:100];
    ...
    [self insertSubview:_talkingImageView atIndex:101];
    ...
    [self insertSubview:_dynamicProgress atIndex:105];
    ...
    _dynamicProgress.center = CGPointMake(self.center.x, self.center.y-32);
    
    micNormalImageView.center = CGPointMake(self.center.x, self.center.y-29);
    _talkingImageView.center = CGPointMake(self.center.x, self.center.y-29);
}
...
-(void) show{
    ...
    [_DEVICE_WINDOW insertSubview:self atIndex:0];
