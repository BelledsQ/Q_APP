...
#define POPLISTVIEW_HEADER_HEIGHT 30.
#define RADIUS 5.
...
- (id)initWithTitle:(NSString *)aTitle options:(NSArray *)aOptions
{
    ...
    if (self = [super initWithFrame:rect])
    {
        ...
        _tableView.separatorColor = [UIColor colorWithWhite:0.333 alpha:0.5];
        _tableView.backgroundColor = [UIColor colorWithWhite:0.333 alpha:0.5];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    static NSString *cellIdentity = @"liPopListViewCell";
    ...
    cell.textLabel.text = [[NSString alloc]initWithFormat:@"%@:%@",[[_options objectAtIndex:row] objectForKey:@"ischeck"],[[_options objectAtIndex:row] objectForKey:@"text"]];
    //cell.detailTextLabel.text = [[_options objectAtIndex:row] objectForKey:@"ischeck"];
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGRect titleRect = CGRectMake(POPLISTVIEW_SCREENINSET + 10, POPLISTVIEW_SCREENINSET + 6,rect.size.width -  2 * (POPLISTVIEW_SCREENINSET + 10), 30);
    CGRect separatorRect = CGRectMake(POPLISTVIEW_SCREENINSET, POPLISTVIEW_SCREENINSET + POPLISTVIEW_HEADER_HEIGHT - 2,rect.size.width - 2 * POPLISTVIEW_SCREENINSET, 2);
