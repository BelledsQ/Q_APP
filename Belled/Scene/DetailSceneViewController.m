...
@interface DetailSceneViewController ()

@end

@implementation DetailSceneViewController
{
...
- (IBAction)sendButtonPressedOnLight:(id)sender
{
    ...
    //[clientSocket sendData:cmdData withTimeout:-1 tag:0];
...
- (IBAction)sendButtonPressedOffLight:(id)sender
{
    ...
    //[clientSocket sendData:cmdData withTimeout:-1 tag:9];
    //[clientSocket disconnectAfterWriting];
}
